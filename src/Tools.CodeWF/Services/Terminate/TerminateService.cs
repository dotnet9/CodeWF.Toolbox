...
namespace Tools.CodeWF.Services.Terminate;
...
public class TerminateService
{
	...
	private TaskCompletionSource ForcefulTerminationRequested { get; } =
	...
	{
		var prevValue =
			Interlocked.CompareExchange(ref _terminateStatus, TerminateStatusInProgress, TerminateStatusNotStarted);
		...
		Logger.LogSoftwareStopped("CodeWF");
	}
}
