...
using System.Text;
using Tools.CodeWF.CodeWF.Models.Serialization;
using Tools.CodeWF.Helpers;
using Tools.CodeWF.Interfaces;
using Tools.CodeWF.Logging;

namespace Tools.CodeWF.Bases;
...
public abstract class ConfigBase : NotifyPropertyChangedBase, IConfig
{
	...
	protected void ToFileNoLock()
	{
		...
		string jsonString =
			JsonConvert.SerializeObject(this, Formatting.Indented, JsonSerializationOptions.Default.Settings);
