...
namespace Tools.CodeWF.Fluent.Models.UI;
...
public class UiContext
{
		...
		IHealthMonitor healthMonitor)
	{
		...
		HardwareWalletInterface =
			hardwareWalletInterface ?? throw new ArgumentNullException(nameof(hardwareWalletInterface));
		FileSystem = fileSystem ?? throw new ArgumentNullException(nameof(fileSystem));
		Config = config ?? throw new ArgumentNullException(nameof(config));
		ApplicationSettings = applicationSettings ?? throw new ArgumentNullException(nameof(applicationSettings));
		TransactionBroadcaster =
			transactionBroadcaster ?? throw new ArgumentNullException(nameof(transactionBroadcaster));
		...
		LegalDocumentsProvider =
			legalDocumentsProvider ?? throw new ArgumentNullException(nameof(legalDocumentsProvider));
