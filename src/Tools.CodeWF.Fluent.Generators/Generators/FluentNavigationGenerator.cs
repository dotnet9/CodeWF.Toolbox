...
internal class FluentNavigationGenerator : GeneratorStep
{
	...
	public override void Execute()
	{
		...
		foreach (var constructor in Constructors)
		{
			...
			var uiContextParam =
				constructor.ParameterList.Parameters.FirstOrDefault(x => x.Type.IsUiContextType(semanticModel));
			...
			var navigationMetadata = viewModelTypeInfo
				...
				.FirstOrDefault(x =>
					...
					NavigationMetaDataGenerator.NavigationMetaDataAttributeDisplayString);
			...
			methodParams =
				methodParams.AddParameters(
					SyntaxFactory.ParseParameterList(additionalMethodParams).Parameters.ToArray());
				...
				SyntaxFactory.ArgumentList(
					SyntaxFactory.SeparatedList(
						constructor.ParameterList
							.Parameters
							.Select(x =>
								x.Type.IsUiContextType(semanticModel)
									? "UiContext"
									: x.Identifier
										.ValueText) // replace uiContext argument for UiContext property reference
