...
{
	public const string NavigationMetaDataAttributeDisplayString = "Tools.CodeWF.Fluent.NavigationMetaDataAttribute";

	private const string NavigationMetaDataDisplayString = "Tools.CodeWF.Fluent.NavigationMetaData";

	private const string RoutableViewModelDisplayString = "Tools.CodeWF.Fluent.ViewModels.Navigation.RoutableViewModel";
	...
	private static string? ProcessClass(Compilation compilation, INamedTypeSymbol classSymbol, ISymbol attributeSymbol,
		ISymbol metadataSymbol)
	{
		...
		var source = new StringBuilder(
			$$"""
			  ...
			  using Tools.CodeWF.Fluent.ViewModels.Navigation;
