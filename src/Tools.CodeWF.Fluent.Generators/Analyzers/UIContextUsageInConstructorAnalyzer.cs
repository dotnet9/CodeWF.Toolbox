...
namespace Tools.CodeWF.Fluent.Generators.Analyzers;
...
{
	public const string UiContextType = "Tools.CodeWF.Fluent.Models.UI.UiContext";
	public const string UiContextFileSuffix = "_UiContext.cs";

	public const string DialogViewModelBaseType =
		"Tools.CodeWF.Fluent.ViewModels.Dialogs.Base.DialogViewModelBase<TResult>";
