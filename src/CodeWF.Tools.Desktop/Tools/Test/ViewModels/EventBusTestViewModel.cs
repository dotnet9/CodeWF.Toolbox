...
namespace CodeWF.Tools.Desktop.Tools.Test.ViewModels;
...
public class EventBusTestViewModel : ViewModelBase
{
    ...
    public EventBusTestViewModel(INotificationService notificationService, IEventBus eventBus,
        IUrsaDialogService dialogService, IUrsaOverlayDialogService overlayDialogService,
    ...
    {
        _overlayDialogService.ShowModal("MainSettings", null,
            options: new OverlayDialogOptions() { Title = "主工程配置", Buttons = DialogButton.OK });
    }

    public void ExecuteShowAloneDialog()
    {
        _dialogService.ShowModal("MainSettings", null,
            options: new DialogOptions() { Title = "主工程配置", Button = DialogButton.OK });
    }

    public void ExecuteDrawer()
    {
        _drawerService.ShowModal("TestModuleSettings", null,
            options: new DrawerOptions() { Title = "子工程配置", Buttons = DialogButton.OK });
    }
}