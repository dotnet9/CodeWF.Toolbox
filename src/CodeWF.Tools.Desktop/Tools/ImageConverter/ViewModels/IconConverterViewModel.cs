namespace CodeWF.Tools.Desktop.Tools.ImageConverter.ViewModels;

public class IconConverterViewModel : ViewModelBase
{
    ...
    public IconConverterViewModel(IFileChooserService fileChooserService, INotificationService notificationService)
    {
